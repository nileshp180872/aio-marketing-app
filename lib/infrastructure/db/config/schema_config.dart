  ...
  void _createCaseStudiesTable() async {
    await _db.execute('''
          ...
          ${DbConstants.caseStudyAIId} INTEGER PRIMARY KEY AUTOINCREMENT,
            ...
            ${DbConstants.caseStudyCompanyId} TEXT,
            ${DbConstants.caseStudyCompanyTitle} TEXT,
            ${DbConstants.caseStudyCompanyName} TEXT,
            ${DbConstants.caseStudyCompanyDescription} TEXT,
            ${DbConstants.caseStudyCompanyImage} TEXT,
            ...
            ${DbConstants.caseStudySolutionImage1} TEXT,
            ${DbConstants.caseStudySolutionImage2} TEXT,
            ${DbConstants.caseStudySolutionImage3} TEXT,
            ${DbConstants.caseStudyThumbnailImage} TEXT,
            ${DbConstants.caseStudyBannerImage} TEXT,
            ${DbConstants.caseStudyBusinessImage1} TEXT,
